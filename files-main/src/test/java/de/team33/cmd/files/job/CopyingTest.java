...
class CopyingTest extends ModifyingTestBase {
    ...
    final void copy_C() throws RequestException {
        Copying.job(Context.of(MUTE, "files", "copy", "C", leftPath().toString(), rightPath().toString()))
               .run();
    ...
    final void copy_U() throws RequestException {
        Copying.job(Context.of(MUTE, "files", "copy", "U", leftPath().toString(), rightPath().toString()))
               .run();
    ...
    final void copy_O() throws RequestException {
        Copying.job(Context.of(MUTE, "files", "copy", "O", leftPath().toString(), rightPath().toString()))
               .run();
    ...
    final void copy_R() throws RequestException {
        Copying.job(Context.of(MUTE, "files", "copy", "R", leftPath().toString(), rightPath().toString()))
               .run();
    ...
    final void copy_D() throws RequestException {
        Copying.job(Context.of(MUTE, "files", "copy", "D", leftPath().toString(), rightPath().toString()))
               .run();
