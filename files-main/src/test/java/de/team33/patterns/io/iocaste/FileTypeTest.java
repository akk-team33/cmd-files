...
class FileTypeTest {
    ...
    public static Stream<Case> validCases() {
        return Stream.of(new Case(MockFileAttributes.REGULAR_FILE, FileType.REGULAR_FILE),
                         ...
                         new Case(new LinkAttributes(LinkHandling.ORIGINAL, // strange case ...
                                                     MockFileAttributes.REGULAR_FILE), FileType.REGULAR_FILE),
                         new Case(new LinkAttributes(LinkHandling.RESOLVE,
                                                     MockFileAttributes.REGULAR_FILE), FileType.REGULAR_FILE),
                         new Case(new LinkAttributes(LinkHandling.ORIGINAL, // strange case ...
                         ...
                         new Case(new LinkAttributes(LinkHandling.RESOLVE,
                                                     MockFileAttributes.OTHER), FileType.SPECIAL_FILE),
                         new Case(new LinkAttributes(LinkHandling.ORIGINAL,
                                                     MockFileAttributes.BASIC_LINK), FileType.SYMBOLIC_LINK),
                         new Case(new LinkAttributes(LinkHandling.RESOLVE, // strange case ...
                                                     MockFileAttributes.BASIC_LINK), FileType.SYMBOLIC_LINK),
                         new Case(new LinkAttributes(LinkHandling.ORIGINAL, // strange case ...
    ...
    public static Stream<BasicFileAttributes> invalidCases() {
        return Stream.of(MockFileAttributes.UNKNOWN,
                         new LinkAttributes(LinkHandling.ORIGINAL, MockFileAttributes.UNKNOWN),
                         new LinkAttributes(LinkHandling.RESOLVE, MockFileAttributes.UNKNOWN));
    }
